...
class TripPlannerService:
    ...
    def plan_optimized_trip(
        ...
        cached_result = self.cache_service.get_cached_optimization(origin, destination, vehicle_params)
        if cached_result:
        ...
        logger.debug(f"Reduced candidates to {len(candidates)} stations", extra={"candidate_count": len(candidates)})
        ...
        self.cache_service.set_cached_optimization(origin, destination, vehicle_params, final_result)
