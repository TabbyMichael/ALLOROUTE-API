...
def sample_stations():
    ...
    return [
        FuelStation(station_id=1, name="Station A", latitude=34.0, longitude=-118.0, price_per_gallon=3.50, address="Addr A", city="City A", state="CA"),
        FuelStation(station_id=2, name="Station B", latitude=35.0, longitude=-117.0, price_per_gallon=3.20, address="Addr B", city="City B", state="CA"),
        FuelStation(station_id=3, name="Station C", latitude=36.0, longitude=-116.0, price_per_gallon=3.80, address="Addr C", city="City C", state="CA"),
    ]
