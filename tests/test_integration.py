...
from apps.trips.domain import OptimizationResult, RouteMetadata, VehicleConfig, Coordinate
...
class TestTripPlannerIntegration:
    ...
    def planner(self, spatial_index):
        ...
        mock_geometry.decode_polyline.return_value = [
            Coordinate(34.0, -118.0), Coordinate(35.0, -117.0), Coordinate(36.0, -116.0)
        ]
        ...
        mock_geometry.downsample_route.return_value = [
            RouteCheckpoint(coordinate=Coordinate(34.0, -118.0), distance_from_start=0, cumulative_time=0.0),
            RouteCheckpoint(coordinate=Coordinate(35.0, -117.0), distance_from_start=400, cumulative_time=0.0),
            RouteCheckpoint(coordinate=Coordinate(36.0, -116.0), distance_from_start=800, cumulative_time=0.0),
        ]
