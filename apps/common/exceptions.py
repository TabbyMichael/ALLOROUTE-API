...
class ExternalServiceError(AlloRouteError):
    ...
    def __init__(self, message: str, code: str = "external_service_error", details: Optional[Dict[str, Any]] = None):
        super().__init__(message, code, details)

class ServiceTimeoutError(ExternalServiceError):
    """Raised when an external service request times out."""
    def __init__(self, message: str, code: str = "service_timeout", details: Optional[Dict[str, Any]] = None):
        super().__init__(message, code, details)
...
class ResourceNotFoundError(AlloRouteError):
    ...
    def __init__(self, message: str, code: str = "resource_not_found", details: Optional[Dict[str, Any]] = None):
        super().__init__(message, code, details)
