...
class GeometryServiceTest(SimpleTestCase):
    ...
    def test_downsample_route(self):
        ...
        coords = [
            Coordinate(latitude=0, longitude=i / 10.0) for i in range(101)
        ]  # 0 to 10 degrees, ~690 miles
        ...
        self.assertAlmostEqual(
            checkpoints[-1].distance_from_start,
            self.service.calculate_cumulative_distances(coords)[-1],
        )
